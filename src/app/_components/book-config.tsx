...
const orderSummary = {
  ...
  wir Ihre Bestellung bearbeiten können. Wir leiten Sie dann zum Zahlungsprozess weiter.
                  </p>          
            ...
            <div className="text-info-950 bg-pirrot-blue-50 w-full max-w-5xl rounded p-2 overflow-y-auto h-full lg:h-auto">
              ...
              <div className="flex h-full flex-col lg:flex-row gap-4">
                ...
                <div className="flex-1 flex flex-col gap-4">
                  ...
                  <p className="w-full max-w-xl">
                    Fast geschafft! Bitte überprüfen Sie die Zusammenfassung Ihrer Bestellung. Wenn alle Angaben korrekt sind, können Sie im nächsten Schritt die Zahlung abschließen.
                  </p>
                  <div className="p-2 bg-pirrot-blue-100/20 border border-pirrot-blue-300/5 rounded">
                    <ul className="space-y-1">
                      ...
                      <li><b>Stückzahl:</b> {orderSummary.amount}x</li>
                      <li><b>Seiten gesamt:</b> {orderSummary.planerPages}</li>
                      <li><b>Einzelpreis:</b> {(orderSummary.single / 100).toFixed(2)} €</li>
                      <li><b>Gesamtpreis:</b> {(orderSummary.price / 100).toFixed(2)} €</li>
                    </ul>
                  </div>
                  ...
                  <div className="mt-4">
                    <h4 className="font-bold mb-2">Ausgewählte Module:</h4>
                    ...
                    <ul className="space-y-2 flex-1 max-h-68 p-1 rounded py-2 border-b border-info-950/5 overflow-y-auto bg-pirrot-blue-950/5">
                      {orderSummary.pickedModuleDetails?.planner.length === 0 && (
                        <li className="italic text-gray-500 ">Keine Module ausgewählt.</li>
                      )}
...
>
  ...
  <p className="w-full max-w-xl">Unsere Suche hat leider für Sie keine Buchvorschau gefunden. Kehren Sie zum Startbildschirm zurück oder loggen Sie sich ein.</p>
...
<div className="flex flex-col gap-2 p-1">
            ...
            <p className="w-full max-w-xl">Hallo! Willkommen bei unserem Buchkonfigurator. Hier können Sie Ihr ganz
   persönliches Buch nach Ihren Wünschen gestalten. Lassen Sie Ihrer
  Kreativität freien Lauf und erschaffen Sie ein einzigartiges Werk, das
...
<div className="flex flex-col gap-2 p-1">
            ...
            <p className="w-full max-w-xl ">  Ihre Ideen, Ihr Material, Ihr Buch. Der Bereich „Eigene Module“ ist
  Ihre kreative Werkstatt. Verwandeln Sie Ihre PDF-Dateien  (ob
  Lehrmaterialien, Arbeitsblätter oder persönliche Notizen) in feste
...
<div className="flex flex-col gap-2 p-1">
            ...
            <p className="w-full max-w-xl">Hier können Sie die passende Bindung für Ihr Buch auswählen. Die Wahl
  der Bindung ist entscheidend für die Langlebigkeit und das
  Erscheinungsbild Ihres Werkes. Entscheiden Sie sich für die Option, die
              ...
              <div className="bg-pirrot-blue-50 flex flex-col gap-2 p-2">
                ...
                >
                  <div className="size-full overflow-y-auto transition-transform duration-300">
                    ...
                    <h5>pro Planer: {(previewPrice.single / 100).toFixed(2)}€</h5>
                  </div>
                </div>
...
export const configWarningTexts = {
  cover: "Umschläge müssen genau 4 Seiten haben. Beachten Sie die Datei größe. (max. 5MB)",
  planner: ""
}
